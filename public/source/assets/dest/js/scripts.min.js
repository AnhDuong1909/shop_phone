! function(a) {
    ...
    a.prototype = {
        ...
        initInstragram: function() { dug({ endpoint: "https://api.instagram.com/v1/users/1140781/media/recent/?client_id=01a35e4dd4bf4d2681e48c88d006636e&count=6", target: jQuery("#beta-instagram-feed")[0], cacheExpire: 3600, template: '            {{#data}}                <a href="{{link}}" target="_blank">                  <img src="{{images.low_resolution.url}}">                </a>            {{/data}}' }) },
        ...
        initTabs: function() {
            jQuery(".woocommerce-tabs .panel").hide(), jQuery(".woocommerce-tabs ul.tabs li a").click(function() {
                ...
                return jQuery("ul.tabs li", b).removeClass("active"), jQuery("div.panel", b).hide(), jQuery("div" + a.attr("href"), b).show(), a.parent().addClass("active"), !1
                    // return jQuery("", b).removeClass(""), jQuery("div.panel", b).hide(), jQuery("div" + a.attr("href"), b).show(), a.parent().addClass(""), !1
